...
import com.chaquo.python.console.Main_Page;
...
implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    public  static final String FILE_NAME = "New_Places.txt";
    ...
    public Button btnIncorrectGuess;
    ...
    public void tryAgain(){
        ...
        btnIncorrectGuess.setVisibility(View.INVISIBLE);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void createInput () {
            ...
            Button btnIncorrectGuess = (Button) findViewById(R.id.btnIncorrectGuess);
                ...
                public void onClick(View v) {
                 ...
                 //   finish();
                   // Intent intent = getIntent();
                    ...
                    Intent intent1 = new Intent(ConsoleActivity.this, Main_Page.class);
                    startActivity(intent1);
                }
            });

            btnIncorrectGuess.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                ...
                public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                    if (actionId == EditorInfo.IME_ACTION_DONE ||
                        ...
                        try {
                            ...
                            Toast.makeText(ConsoleActivity.this, "Saved to " + getFilesDir() + "/" + FILE_NAME, Toast.LENGTH_LONG).show();
                            tryAgain();
        ...
        private void output (CharSequence text){
            ...
            if (scrollback.length() > MAX_SCROLLBACK_LEN) {
                scrollback.delete(0, MAX_SCROLLBACK_LEN / 20);
            }
